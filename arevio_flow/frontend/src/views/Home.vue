    ...
    <div class="row" style=" display: flex; align-items: center;">
      <div class="col-6">
        ...
        <b-button-toolbar class="mb-3">
          <b-button class="mr-2" :disabled="selectedCompany === null" size="sm" v-b-modal.modal-new-report>New report</b-button>
    ...
    <p>
      ...
      >
        <template v-slot:cell(actions)="row">
          <b-button size="sm" class="mr-1" @click=""> Download </b-button>
          <b-button size="sm" class="mr-1" @click=""> Upload </b-button>
          <b-button size="sm" class="mr-1" @click=""> Preview </b-button>
        </template>
      </b-table>
    </p>
    <b-modal
  ...
  methods: {
    ...
    onClickDeleteReport() {
      ...
      rowsToDelete.forEach(row => {
        apiService(`/annualreports/${row.id}/`, "DELETE")
          .then(() => this.$emit('fetchData'))
      });
    },
    initModal(e) {
